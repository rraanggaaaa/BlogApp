...
const ForgotPassword = () => {
    ...
    return (
        <>
        <html class="flex items-center justify-center min-h-screen bg-slate-900">
            <body class="h-full">
                <div className="flex  bg-slate-100 min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-16 rounded-lg">
